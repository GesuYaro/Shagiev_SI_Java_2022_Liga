...
class FilterByStatusCommandTest {
    ...
    FilterByStatusCommand command = new FilterByStatusCommand(taskFactoryMock, taskManagerMock, writer);

    {
        Mockito.when(taskFactoryMock.getTaskStatus(getValidArgs()[1])).thenReturn(getValidStatus());
        Mockito.when(taskManagerMock.getTasksByStatus(getValidId(), getValidStatus())).thenReturn(getTasks());
    }
    ...
    List<Task> getTasks() {
        ...
        list.add(new Task(2, "Test2", "Testtesttest", new Date(999999999), TaskStatus.NEW, 1));
        list.add(new Task(6, "Test6", "Testtesttest", new Date(1889999999), TaskStatus.NEW, 1));
        list.add(new Task(9, "Test9", "Testtesttest", new Date(1997779991), TaskStatus.NEW, 1));
        list.add(new Task(100, "Test100", "Testtesttest", new Date(1222922299), TaskStatus.NEW, 1));
        return list;
    }
